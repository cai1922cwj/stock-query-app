...
export const stockApi = {
  ...
  searchStocks: async (keyword) => {
    ...
    const mockStocks = [
      ...
      { code: 'sh600015', name: '华夏银行', market: 'A股' },
      { code: 'sh600016', name: '民生银行', market: 'A股' },
      { code: 'sh601009', name: '南京银行', market: 'A股' },
      { code: 'sh601169', name: '北京银行', market: 'A股' },
      { code: 'sh601229', name: '上海银行', market: 'A股' },
      { code: 'sh601288', name: '农业银行', market: 'A股' },
      { code: 'sh601328', name: '交通银行', market: 'A股' },
      { code: 'sh601658', name: '邮储银行', market: 'A股' },
      { code: 'sh601818', name: '光大银行', market: 'A股' },
      { code: 'sh601939', name: '建设银行', market: 'A股' },
      { code: 'sh601988', name: '中国银行', market: 'A股' },
      { code: 'sh601998', name: '中信银行', market: 'A股' },
      { code: 'sz000001', name: '平安银行', market: 'A股' },
      { code: 'sz002142', name: '宁波银行', market: 'A股' },
      { code: 'sz002807', name: '江阴银行', market: 'A股' },
      { code: 'sz002839', name: '张家港行', market: 'A股' },
      
      // 科技/电子/通信
      { code: 'sh600498', name: '烽火通信', market: 'A股' },
      { code: 'sh600570', name: '恒生电子', market: 'A股' },
      { code: 'sh600584', name: '长电科技', market: 'A股' },
      { code: 'sh600745', name: '闻泰科技', market: 'A股' },
      { code: 'sh603019', name: '中科曙光', market: 'A股' },
      { code: 'sh603160', name: '汇顶科技', market: 'A股' },
      { code: 'sh603501', name: '韦尔股份', market: 'A股' },
      { code: 'sh603986', name: '兆易创新', market: 'A股' },
      { code: 'sh688008', name: '澜起科技', market: 'A股' },
      { code: 'sh688012', name: '中微公司', market: 'A股' },
      { code: 'sh688036', name: '传音控股', market: 'A股' },
      { code: 'sh688111', name: '金山办公', market: 'A股' },
      { code: 'sh688599', name: '天合光能', market: 'A股' },
      { code: 'sz000063', name: '中兴通讯', market: 'A股' },
      { code: 'sz000938', name: '紫光股份', market: 'A股' },
      { code: 'sz002049', name: '紫光国微', market: 'A股' },
      { code: 'sz002156', name: '通富微电', market: 'A股' },
      { code: 'sz002180', name: '纳思达', market: 'A股' },
      { code: 'sz002230', name: '科大讯飞', market: 'A股' },
      { code: 'sz002236', name: '大华股份', market: 'A股' },
      { code: 'sz002371', name: '北方华创', market: 'A股' },
      { code: 'sz002384', name: '东山精密', market: 'A股' },
      { code: 'sz002463', name: '沪电股份', market: 'A股' },
      { code: 'sz300014', name: '亿纬锂能', market: 'A股' },
      { code: 'sz300033', name: '同花顺', market: 'A股' },
      { code: 'sz300124', name: '汇川技术', market: 'A股' },
      { code: 'sz300408', name: '三环集团', market: 'A股' },
      { code: 'sz300433', name: '蓝思科技', market: 'A股' },
      { code: 'sz300498', name: '温氏股份', market: 'A股' },
      { code: 'sz300661', name: '圣邦股份', market: 'A股' },
      { code: 'sz300750', name: '宁德时代', market: 'A股' },
      { code: 'sz300760', name: '迈瑞医疗', market: 'A股' },
      { code: 'sz300782', name: '卓胜微', market: 'A股' },
      { code: 'sz300866', name: '安克创新', market: 'A股' },
      
      // 医药/医疗
      { code: 'sh600196', name: '复星医药', market: 'A股' },
      { code: 'sh600436', name: '片仔癀', market: 'A股' },
      { code: 'sh600535', name: '天士力', market: 'A股' },
      { code: 'sh600763', name: '通策医疗', market: 'A股' },
      { code: 'sh603259', name: '药明康德', market: 'A股' },
      { code: 'sh603288', name: '海天味业', market: 'A股' },
      { code: 'sh603392', name: '万泰生物', market: 'A股' },
      { code: 'sh603658', name: '安图生物', market: 'A股' },
      { code: 'sh688185', name: '康希诺', market: 'A股' },
      { code: 'sh688271', name: '联影医疗', market: 'A股' },
      { code: 'sz000538', name: '云南白药', market: 'A股' },
      { code: 'sz000623', name: '吉林敖东', market: 'A股' },
      { code: 'sz000661', name: '长春高新', market: 'A股' },
      { code: 'sz000999', name: '华润三九', market: 'A股' },
      { code: 'sz002001', name: '新和成', market: 'A股' },
      { code: 'sz002007', name: '华兰生物', market: 'A股' },
      { code: 'sz002252', name: '上海莱士', market: 'A股' },
      { code: 'sz002603', name: '以岭药业', market: 'A股' },
      { code: 'sz300003', name: '乐普医疗', market: 'A股' },
      { code: 'sz300015', name: '爱尔眼科', market: 'A股' },
      { code: 'sz300122', name: '智飞生物', market: 'A股' },
      { code: 'sz300142', name: '沃森生物', market: 'A股' },
      { code: 'sz300347', name: '泰格医药', market: 'A股' },
      { code: 'sz300896', name: '爱美客', market: 'A股' },
      
      // 新能源/汽车
      { code: 'sh600066', name: '宇通客车', market: 'A股' },
      { code: 'sh600104', name: '上汽集团', market: 'A股' },
      { code: 'sh600406', name: '国电南瑞', market: 'A股' },
      { code: 'sh600438', name: '通威股份', market: 'A股' },
      { code: 'sh600885', name: '宏发股份', market: 'A股' },
      { code: 'sh601012', name: '隆基绿能', market: 'A股' },
      { code: 'sh601127', name: '赛力斯', market: 'A股' },
      { code: 'sh601633', name: '长城汽车', market: 'A股' },
      { code: 'sh601689', name: '拓普集团', market: 'A股' },
      { code: 'sh601799', name: '星宇股份', market: 'A股' },
      { code: 'sh603596', name: '伯特利', market: 'A股' },
      { code: 'sh603659', name: '璞泰来', market: 'A股' },
      { code: 'sh603806', name: '福斯特', market: 'A股' },
      { code: 'sz000625', name: '长安汽车', market: 'A股' },
      { code: 'sz000768', name: '中航西飞', market: 'A股' },
      { code: 'sz002028', name: '思源电气', market: 'A股' },
      { code: 'sz002074', name: '国轩高科', market: 'A股' },
      { code: 'sz002120', name: '韵达股份', market: 'A股' },
      { code: 'sz002129', name: 'TCL中环', market: 'A股' },
      { code: 'sz002202', name: '金风科技', market: 'A股' },
      { code: 'sz002271', name: '东方雨虹', market: 'A股' },
      { code: 'sz002340', name: '格林美', market: 'A股' },
      { code: 'sz002459', name: '晶澳科技', market: 'A股' },
      { code: 'sz002460', name: '赣锋锂业', market: 'A股' },
      { code: 'sz002466', name: '天齐锂业', market: 'A股' },
      { code: 'sz002594', name: '比亚迪', market: 'A股' },
      { code: 'sz002709', name: '天赐材料', market: 'A股' },
      { code: 'sz002812', name: '恩捷股份', market: 'A股' },
      { code: 'sz300014', name: '亿纬锂能', market: 'A股' },
      { code: 'sz300274', name: '阳光电源', market: 'A股' },
      { code: 'sz300316', name: '晶盛机电', market: 'A股' },
      { code: 'sz300390', name: '天华新能', market: 'A股' },
      { code: 'sz300450', name: '先导智能', market: 'A股' },
      { code: 'sz300568', name: '星源材质', market: 'A股' },
      { code: 'sz300724', name: '捷佳伟创', market: 'A股' },
      { code: 'sz300919', name: '中伟股份', market: 'A股' },
      
      // 消费/食品饮料
      { code: 'sh600298', name: '安琪酵母', market: 'A股' },
      { code: 'sh600519', name: '贵州茅台', market: 'A股' },
      { code: 'sh600600', name: '青岛啤酒', market: 'A股' },
      { code: 'sh603288', name: '海天味业', market: 'A股' },
      { code: 'sh603345', name: '安井食品', market: 'A股' },
      { code: 'sh605117', name: '德业股份', market: 'A股' },
      { code: 'sz000568', name: '泸州老窖', market: 'A股' },
      { code: 'sz000596', name: '古井贡酒', market: 'A股' },
      { code: 'sz000651', name: '格力电器', market: 'A股' },
      { code: 'sz000723', name: '美锦能源', market: 'A股' },
      { code: 'sz000768', name: '中航西飞', market: 'A股' },
      { code: 'sz000786', name: '北新建材', market: 'A股' },
      { code: 'sz000830', name: '鲁西化工', market: 'A股' },
      { code: 'sz000858', name: '五粮液', market: 'A股' },
      { code: 'sz000895', name: '双汇发展', market: 'A股' },
      { code: 'sz002001', name: '新和成', market: 'A股' },
      { code: 'sz002007', name: '华兰生物', market: 'A股' },
      { code: 'sz00858', name: '五粮液', market: 'A股' },
      { code: 'sz002032', name: '苏泊尔', market: 'A股' },
      { code: 'sz002044', name: '美年健康', market: 'A股' },
      { code: 'sz002120', name: '韵达股份', market: 'A股' },
      { code: 'sz002142', name: '宁波银行', market: 'A股' },
      { code: 'sz002156', name: '通富微电', market: 'A股' },
      { code: 'sz002271', name: '东方雨虹', market: 'A股' },
      { code: 'sz002304', name: '洋河股份', market: 'A股' },
      { code: 'sz002311', name: '海大集团', market: 'A股' },
      { code: 'sz002352', name: '顺丰控股', market: 'A股' },
      { code: 'sz002415', name: '海康威视', market: 'A股' },
      { code: 'sz002460', name: '赣锋锂业', market: 'A股' },
      { code: 'sz002475', name: '立讯精密', market: 'A股' },
      { code: 'sz002493', name: '荣盛石化', market: 'A股' },
      { code: 'sz002555', name: '三七互娱', market: 'A股' },
      { code: 'sz002594', name: '比亚迪', market: 'A股' },
      { code: 'sz002600', name: '领益智造', market: 'A股' },
      { code: 'sz002648', name: '卫星化学', market: 'A股' },
      { code: 'sz002714', name: '牧原股份', market: 'A股' },
      { code: 'sz002812', name: '恩捷股份', market: 'A股' },
      { code: 'sz002821', name: '凯莱英', market: 'A股' },
      { code: 'sz002841', name: '视源股份', market: 'A股' },
      { code: 'sz300003', name: '乐普医疗', market: 'A股' },
      { code: 'sz300015', name: '爱尔眼科', market: 'A股' },
      { code: 'sz300033', name: '同花顺', market: 'A股' },
      { code: 'sz300059', name: '东方财富', market: 'A股' },
      ...
      // 房地产/基建
      { code: 'sh600048', name: '保利发展', market: 'A股' },
      { code: 'sh600340', name: '华夏幸福', market: 'A股' },
      { code: 'sh600383', name: '金地集团', market: 'A股' },
      { code: 'sh600606', name: '绿地控股', market: 'A股' },
      { code: 'sh600657', name: '信达地产', market: 'A股' },
      { code: 'sh601668', name: '中国建筑', market: 'A股' },
      { code: 'sh601800', name: '中国交建', market: 'A股' },
      { code: 'sh601868', name: '中国能建', market: 'A股' },
      { code: 'sh601880', name: '大连港', market: 'A股' },
      { code: 'sh601886', name: '江河集团', market: 'A股' },
      { code: 'sh601989', name: '中国重工', market: 'A股' },
      { code: 'sz000002', name: '万科A', market: 'A股' },
      { code: 'sz000006', name: '深振业A', market: 'A股' },
      { code: 'sz000069', name: '华侨城A', market: 'A股' },
      { code: 'sz000090', name: '天健集团', market: 'A股' },
      { code: 'sz000402', name: '金融街', market: 'A股' },
      
      // 交通运输
      { code: 'sh600004', name: '白云机场', market: 'A股' },
      { code: 'sh600009', name: '上海机场', market: 'A股' },
      { code: 'sh600018', name: '上港集团', market: 'A股' },
      { code: 'sh600029', name: '南方航空', market: 'A股' },
      { code: 'sh600115', name: '中国东航', market: 'A股' },
      { code: 'sh600221', name: '海航控股', market: 'A股' },
      { code: 'sh600350', name: '山东高速', market: 'A股' },
      { code: 'sh600377', name: '宁沪高速', market: 'A股' },
      { code: 'sh601006', name: '大秦铁路', market: 'A股' },
      { code: 'sh601111', name: '中国国航', market: 'A股' },
      { code: 'sh601816', name: '京沪高铁', market: 'A股' },
      { code: 'sh601872', name: '招商轮船', market: 'A股' },
      { code: 'sh601919', name: '中远海控', market: 'A股' },
      { code: 'sz000089', name: '深圳机场', market: 'A股' },
      
      // 其他行业
      { code: 'sh600007', name: '中国国贸', market: 'A股' },
      { code: 'sh600008', name: '首创环保', market: 'A股' },
      { code: 'sh600009', name: '上海机场', market: 'A股' },
      { code: 'sh600010', name: '包钢股份', market: 'A股' },
      { code: 'sh600019', name: '宝钢股份', market: 'A股' },
      { code: 'sh600028', name: '中国石化', market: 'A股' },
      { code: 'sh600030', name: '中信证券', market: 'A股' },
      { code: 'sh600031', name: '三一重工', market: 'A股' },
      { code: 'sh600048', name: '保利发展', market: 'A股' },
      { code: 'sh600050', name: '中国联通', market: 'A股' },
      { code: 'sh600061', name: '国投资本', market: 'A股' },
      { code: 'sh600085', name: '同仁堂', market: 'A股' },
      { code: 'sh600104', name: '上汽集团', market: 'A股' },
      { code: 'sh600109', name: '国金证券', market: 'A股' },
      { code: 'sh600111', name: '北方稀土', market: 'A股' },
      { code: 'sh600132', name: '重庆啤酒', market: 'A股' },
      { code: 'sh600143', name: '金发科技', market: 'A股' },
      { code: 'sh600150', name: '中国船舶', market: 'A股' },
      { code: 'sh600161', name: '天坛生物', market: 'A股' },
      { code: 'sh600170', name: '上海建工', market: 'A股' },
      { code: 'sh600176', name: '中国巨石', market: 'A股' },
      { code: 'sh600183', name: '生益科技', market: 'A股' },
      { code: 'sh600188', name: '兖矿能源', market: 'A股' },
      { code: 'sh600196', name: '复星医药', market: 'A股' },
      { code: 'sh600208', name: '新湖中宝', market: 'A股' },
      { code: 'sh600219', name: '南山铝业', market: 'A股' },
      { code: 'sh600233', name: '圆通速递', market: 'A股' },
      { code: 'sh600271', name: '航天信息', market: 'A股' },
      { code: 'sh600276', name: '恒瑞医药', market: 'A股' },
      { code: 'sh600297', name: '广汇汽车', market: 'A股' },
      { code: 'sh600309', name: '万华化学', market: 'A股' },
      { code: 'sh600315', name: '上海家化', market: 'A股' },
      { code: 'sh600332', name: '白云山', market: 'A股' },
      { code: 'sh600346', name: '恒力石化', market: 'A股' },
      { code: 'sh600362', name: '江西铜业', market: 'A股' },
      { code: 'sh600372', name: '中航电子', market: 'A股' },
      { code: 'sh600406', name: '国电南瑞', market: 'A股' },
      { code: 'sh600436', name: '片仔癀', market: 'A股' },
      { code: 'sh600438', name: '通威股份', market: 'A股' },
      { code: 'sh600460', name: '士兰微', market: 'A股' },
      { code: 'sh600489', name: '中金黄金', market: 'A股' },
      { code: 'sh600498', name: '烽火通信', market: 'A股' },
      { code: 'sh600519', name: '贵州茅台', market: 'A股' },
      { code: 'sh600522', name: '中天科技', market: 'A股' },
      { code: 'sh600535', name: '天士力', market: 'A股' },
      { code: 'sh600547', name: '山东黄金', market: 'A股' },
      { code: 'sh600570', name: '恒生电子', market: 'A股' },
      { code: 'sh600584', name: '长电科技', market: 'A股' },
      { code: 'sh600585', name: '海螺水泥', market: 'A股' },
      { code: 'sh600588', name: '用友网络', market: 'A股' },
      { code: 'sh600600', name: '青岛啤酒', market: 'A股' },
      { code: 'sh600606', name: '绿地控股', market: 'A股' },
      { code: 'sh600637', name: '东方明珠', market: 'A股' },
      { code: 'sh600660', name: '福耀玻璃', market: 'A股' },
      { code: 'sh600674', name: '川投能源', market: 'A股' },
      { code: 'sh600690', name: '海尔智家', market: 'A股' },
      { code: 'sh600703', name: '三安光电', market: 'A股' },
      { code: 'sh600745', name: '闻泰科技', market: 'A股' },
      { code: 'sh600760', name: '中航沈飞', market: 'A股' },
      { code: 'sh600763', name: '通策医疗', market: 'A股' },
      { code: 'sh600795', name: '国电电力', market: 'A股' },
      { code: 'sh600809', name: '山西汾酒', market: 'A股' },
      { code: 'sh600837', name: '海通证券', market: 'A股' },
      { code: 'sh600845', name: '宝信软件', market: 'A股' },
      { code: 'sh600859', name: '王府井', market: 'A股' },
      { code: 'sh600867', name: '通化东宝', market: 'A股' },
      { code: 'sh600872', name: '中炬高新', market: 'A股' },
      { code: 'sh600886', name: '国投电力', market: 'A股' },
      { code: 'sh600887', name: '伊利股份', market: 'A股' },
      { code: 'sh600893', name: '航发动力', market: 'A股' },
      { code: 'sh600900', name: '长江电力', market: 'A股' },
      { code: 'sh600919', name: '江苏银行', market: 'A股' },
      { code: 'sh600926', name: '杭州银行', market: 'A股' },
      { code: 'sh600958', name: '东方证券', market: 'A股' },
      { code: 'sh600989', name: '宝丰能源', market: 'A股' },
      { code: 'sh601012', name: '隆基绿能', market: 'A股' },
      { code: 'sh601021', name: '春秋航空', market: 'A股' },
      { code: 'sh601066', name: '中信建投', market: 'A股' },
      { code: 'sh601088', name: '中国神华', market: 'A股' },
      { code: 'sh601100', name: '恒立液压', market: 'A股' },
      { code: 'sh601108', name: '财通证券', market: 'A股' },
      { code: 'sh601111', name: '中国国航', market: 'A股' },
      { code: 'sh601117', name: '中国化学', market: 'A股' },
      { code: 'sh601127', name: '赛力斯', market: 'A股' },
      { code: 'sh601155', name: '新城控股', market: 'A股' },
      { code: 'sh601211', name: '国泰君安', market: 'A股' },
      { code: 'sh601225', name: '陕西煤业', market: 'A股' },
      { code: 'sh601236', name: '红塔证券', market: 'A股' },
      { code: 'sh601238', name: '广汽集团', market: 'A股' },
      { code: 'sh601288', name: '农业银行', market: 'A股' },
      { code: 'sh601318', name: '中国平安', market: 'A股' },
      { code: 'sh601319', name: '中国人保', market: 'A股' },
      { code: 'sh601336', name: '新华保险', market: 'A股' },
      { code: 'sh601360', name: '三六零', market: 'A股' },
      { code: 'sh601377', name: '兴业证券', market: 'A股' },
      { code: 'sh601390', name: '中国中铁', market: 'A股' },
      { code: 'sh601398', name: '工商银行', market: 'A股' },
      { code: 'sh601555', name: '东吴证券', market: 'A股' },
      { code: 'sh601577', name: '长沙银行', market: 'A股' },
      { code: 'sh601601', name: '中国太保', market: 'A股' },
      { code: 'sh601607', name: '上海医药', market: 'A股' },
      { code: 'sh601618', name: '中国中冶', market: 'A股' },
      { code: 'sh601628', name: '中国人寿', market: 'A股' },
      { code: 'sh601633', name: '长城汽车', market: 'A股' },
      { code: 'sh601658', name: '邮储银行', market: 'A股' },
      { code: 'sh601668', name: '中国建筑', market: 'A股' },
      { code: 'sh601669', name: '中国电建', market: 'A股' },
      { code: 'sh601688', name: '华泰证券', market: 'A股' },
      { code: 'sh601689', name: '拓普集团', market: 'A股' },
      { code: 'sh601698', name: '中国卫通', market: 'A股' },
      { code: 'sh601728', name: '中国电信', market: 'A股' },
      { code: 'sh601766', name: '中国中车', market: 'A股' },
      { code: 'sh601788', name: '光大证券', market: 'A股' },
      { code: 'sh601799', name: '星宇股份', market: 'A股' },
      { code: 'sh601800', name: '中国交建', market: 'A股' },
      { code: 'sh601808', name: '中海油服', market: 'A股' },
      { code: 'sh601816', name: '京沪高铁', market: 'A股' },
      { code: 'sh601818', name: '光大银行', market: 'A股' },
      { code: 'sh601838', name: '成都银行', market: 'A股' },
      { code: 'sh601857', name: '中国石油', market: 'A股' },
      { code: 'sh601868', name: '中国能建', market: 'A股' },
      { code: 'sh601872', name: '招商轮船', market: 'A股' },
      { code: 'sh601877', name: '正泰电器', market: 'A股' },
      { code: 'sh601878', name: '浙商证券', market: 'A股' },
      { code: 'sh601881', name: '中国银河', market: 'A股' },
      { code: 'sh601888', name: '中国中免', market: 'A股' },
      { code: 'sh601899', name: '紫金矿业', market: 'A股' },
      { code: 'sh601901', name: '方正证券', market: 'A股' },
      { code: 'sh601916', name: '浙商银行', market: 'A股' },
      { code: 'sh601919', name: '中远海控', market: 'A股' },
      { code: 'sh601933', name: '永辉超市', market: 'A股' },
      { code: 'sh601939', name: '建设银行', market: 'A股' },
      { code: 'sh601985', name: '中国核电', market: 'A股' },
      { code: 'sh601988', name: '中国银行', market: 'A股' },
      { code: 'sh601989', name: '中国重工', market: 'A股' },
      { code: 'sh601998', name: '中信银行', market: 'A股' },
      { code: 'sh603019', name: '中科曙光', market: 'A股' },
      { code: 'sh603027', name: '千禾味业', market: 'A股' },
      { code: 'sh603078', name: '江化微', market: 'A股' },
      { code: 'sh603127', name: '昭衍新药', market: 'A股' },
      { code: 'sh603160', name: '汇顶科技', market: 'A股' },
      { code: 'sh603195', name: '公牛集团', market: 'A股' },
      { code: 'sh603218', name: '日月股份', market: 'A股' },
      { code: 'sh603233', name: '大参林', market: 'A股' },
      { code: 'sh603259', name: '药明康德', market: 'A股' },
      { code: 'sh603288', name: '海天味业', market: 'A股' },
      { code: 'sh603290', name: '斯达半导', market: 'A股' },
      { code: 'sh603296', name: '华勤技术', market: 'A股' },
      { code: 'sh603345', name: '安井食品', market: 'A股' },
      { code: 'sh603392', name: '万泰生物', market: 'A股' },
      { code: 'sh603486', name: '科沃斯', market: 'A股' },
      { code: 'sh603501', name: '韦尔股份', market: 'A股' },
      { code: 'sh603517', name: '绝味食品', market: 'A股' },
      { code: 'sh603596', name: '伯特利', market: 'A股' },
      { code: 'sh603658', name: '安图生物', market: 'A股' },
      { code: 'sh603659', name: '璞泰来', market: 'A股' },
      { code: 'sh603799', name: '华友钴业', market: 'A股' },
      { code: 'sh603806', name: '福斯特', market: 'A股' },
      { code: 'sh603882', name: '金域医学', market: 'A股' },
      { code: 'sh603893', name: '瑞芯微', market: 'A股' },
      { code: 'sh603939', name: '益丰药房', market: 'A股' },
      { code: 'sh603986', name: '兆易创新', market: 'A股' },
      { code: 'sh603993', name: '洛阳钼业', market: 'A股' },
      { code: 'sh605117', name: '德业股份', market: 'A股' },
      { code: 'sh605358', name: '立昂微', market: 'A股' },
      { code: 'sh605499', name: '东鹏饮料', market: 'A股' },
      { code: 'sh688008', name: '澜起科技', market: 'A股' },
      { code: 'sh688009', name: '中国通号', market: 'A股' },
      { code: 'sh688012', name: '中微公司', market: 'A股' },
      { code: 'sh688036', name: '传音控股', market: 'A股' },
      { code: 'sh688082', name: '盛美上海', market: 'A股' },
      { code: 'sh688111', name: '金山办公', market: 'A股' },
      { code: 'sh688126', name: '沪硅产业', market: 'A股' },
      { code: 'sh688169', name: '石头科技', market: 'A股' },
      { code: 'sh688185', name: '康希诺', market: 'A股' },
      { code: 'sh688223', name: '晶科能源', market: 'A股' },
      { code: 'sh688271', name: '联影医疗', market: 'A股' },
      { code: 'sh688303', name: '大全能源', market: 'A股' },
      { code: 'sh688363', name: '华熙生物', market: 'A股' },
      { code: 'sh688599', name: '天合光能', market: 'A股' },
      { code: 'sh688981', name: '中芯国际', market: 'A股' },
      { code: 'sz000002', name: '万科A', market: 'A股' },
      { code: 'sz000006', name: '深振业A', market: 'A股' },
      ...
      { code: 'sz000089', name: '深圳机场', market: 'A股' },
      { code: 'sz000090', name: '天健集团', market: 'A股' },
      { code: 'sz000100', name: 'TCL科技', market: 'A股' },
      { code: 'sz000166', name: '申万宏源', market: 'A股' },
      { code: 'sz000301', name: '东方盛虹', market: 'A股' },
      { code: 'sz000333', name: '美的集团', market: 'A股' },
      { code: 'sz000338', name: '潍柴动力', market: 'A股' },
      { code: 'sz000402', name: '金融街', market: 'A股' },
      { code: 'sz000408', name: '藏格矿业', market: 'A股' },
      { code: 'sz000425', name: '徐工机械', market: 'A股' },
      { code: 'sz000538', name: '云南白药', market: 'A股' },
      { code: 'sz000568', name: '泸州老窖', market: 'A股' },
      { code: 'sz000596', name: '古井贡酒', market: 'A股' },
      { code: 'sz000617', name: '中油资本', market: 'A股' },
      { code: 'sz000623', name: '吉林敖东', market: 'A股' },
      { code: 'sz000625', name: '长安汽车', market: 'A股' },
      { code: 'sz000630', name: '铜陵有色', market: 'A股' },
      { code: 'sz000651', name: '格力电器', market: 'A股' },
      { code: 'sz000661', name: '长春高新', market: 'A股' },
      { code: 'sz000723', name: '美锦能源', market: 'A股' },
      { code: 'sz000725', name: '京东方A', market: 'A股' },
      { code: 'sz000768', name: '中航西飞', market: 'A股' },
      { code: 'sz000786', name: '北新建材', market: 'A股' },
      { code: 'sz000792', name: '盐湖股份', market: 'A股' },
      { code: 'sz000807', name: '云铝股份', market: 'A股' },
      { code: 'sz000830', name: '鲁西化工', market: 'A股' },
      { code: 'sz000858', name: '五粮液', market: 'A股' },
      { code: 'sz000895', name: '双汇发展', market: 'A股' },
      { code: 'sz000938', name: '紫光股份', market: 'A股' },
      { code: 'sz000963', name: '华东医药', market: 'A股' },
      { code: 'sz000999', name: '华润三九', market: 'A股' },
      { code: 'sz001289', name: '龙源电力', market: 'A股' },
      { code: 'sz001979', name: '招商蛇口', market: 'A股' },
      { code: 'sz002001', name: '新和成', market: 'A股' },
      { code: 'sz002007', name: '华兰生物', market: 'A股' },
      { code: 'sz002008', name: '大族激光', market: 'A股' },
      { code: 'sz002024', name: '苏宁易购', market: 'A股' },
      { code: 'sz002027', name: '分众传媒', market: 'A股' },
      { code: 'sz002028', name: '思源电气', market: 'A股' },
      { code: 'sz002032', name: '苏泊尔', market: 'A股' },
      { code: 'sz002044', name: '美年健康', market: 'A股' },
      { code: 'sz002049', name: '紫光国微', market: 'A股' },
      { code: 'sz002050', name: '三花智控', market: 'A股' },
      { code: 'sz002074', name: '国轩高科', market: 'A股' },
      { code: 'sz002120', name: '韵达股份', market: 'A股' },
      { code: 'sz002129', name: 'TCL中环', market: 'A股' },
      { code: 'sz002142', name: '宁波银行', market: 'A股' },
      { code: 'sz002156', name: '通富微电', market: 'A股' },
      { code: 'sz002179', name: '中航光电', market: 'A股' },
      { code: 'sz002180', name: '纳思达', market: 'A股' },
      { code: 'sz002202', name: '金风科技', market: 'A股' },
      { code: 'sz002230', name: '科大讯飞', market: 'A股' },
      { code: 'sz002236', name: '大华股份', market: 'A股' },
      ...
      { code: 'sz002371', name: '北方华创', market: 'A股' },
      { code: 'sz002384', name: '东山精密', market: 'A股' },
      { code: 'sz002410', name: '广联达', market: 'A股' },
      { code: 'sz002414', name: '高德红外', market: 'A股' },
      { code: 'sz002415', name: '海康威视', market: 'A股' },
      { code: 'sz002459', name: '晶澳科技', market: 'A股' },
      { code: 'sz002460', name: '赣锋锂业', market: 'A股' },
      { code: 'sz002463', name: '沪电股份', market: 'A股' },
      ...
      { code: 'sz002594', name: '比亚迪', market: 'A股' },
      { code: 'sz002600', name: '领益智造', market: 'A股' },
      { code: 'sz002601', name: '龙佰集团', market: 'A股' },
      { code: 'sz002603', name: '以岭药业', market: 'A股' },
      { code: 'sz002648', name: '卫星化学', market: 'A股' },
      { code: 'sz002709', name: '天赐材料', market: 'A股' },
      { code: 'sz002714', name: '牧原股份', market: 'A股' },
      { code: 'sz002756', name: '永兴材料', market: 'A股' },
      { code: 'sz002812', name: '恩捷股份', market: 'A股' },
      { code: 'sz002821', name: '凯莱英', market: 'A股' },
      { code: 'sz002841', name: '视源股份', market: 'A股' },
      { code: 'sz002920', name: '德赛西威', market: 'A股' },
      { code: 'sz002938', name: '鹏鼎控股', market: 'A股' },
      { code: 'sz300003', name: '乐普医疗', market: 'A股' },
      { code: 'sz300014', name: '亿纬锂能', market: 'A股' },
      { code: 'sz300015', name: '爱尔眼科', market: 'A股' },
      { code: 'sz300033', name: '同花顺', market: 'A股' },
      ...
      { code: 'sz300390', name: '天华新能', market: 'A股' },
      { code: 'sz300408', name: '三环集团', market: 'A股' },
      { code: 'sz300413', name: '芒果超媒', market: 'A股' },
      { code: 'sz300433', name: '蓝思科技', market: 'A股' },
      { code: 'sz300450', name: '先导智能', market: 'A股' },
      { code: 'sz300498', name: '温氏股份', market: 'A股' },
      { code: 'sz300568', name: '星源材质', market: 'A股' },
      ...
      { code: 'sz300896', name: '爱美客', market: 'A股' },
      { code: 'sz300919', name: '中伟股份', market: 'A股' },
      { code: 'sz301269', name: '华大九天', market: 'A股' },
